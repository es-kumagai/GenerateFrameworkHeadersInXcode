...
// UUID: CFCCE1DB-DBBB-3194-83C2-848EE6FC2B76
//
//                           Arch: x86_64
...
- (void)deliverResultsBatch:(NSArray *)arg1 final:(_Bool)arg2 error:(NSError *)arg3 forQuery:(NSUUID *)arg4;
...
- (void)deliverResultsBatch:(id)arg1 final:(_Bool)arg2 error:(id)arg3 forQuery:(id)arg4;
...
- (_Bool)pptTest:(id)arg1 preflightHealthDirectory:(id)arg2 sampleTypes:(id)arg3 killHealthd:(_Bool)arg4;
- (_Bool)pptTest:(id)arg1 journalMergeAtHealthDirectory:(id)arg2;
- (_Bool)pptTest:(id)arg1 collectionQueryForType:(id)arg2 anchorDate:(id)arg3 startDate:(id)arg4 endDate:(id)arg5 dateIntervalsString:(id)arg6 separateBySource:(_Bool)arg7 average:(_Bool)arg8 minimum:(_Bool)arg9 maximum:(_Bool)arg10 sum:(_Bool)arg11;
- (_Bool)pptTest:(id)arg1 statisticsQueryForType:(id)arg2 startDate:(id)arg3 endDate:(id)arg4 separateBySource:(_Bool)arg5 average:(_Bool)arg6 minimum:(_Bool)arg7 maximum:(_Bool)arg8 sum:(_Bool)arg9;
- (_Bool)pptTest:(id)arg1 anchoredQueryForType:(id)arg2 startDate:(id)arg3 endDate:(id)arg4 withLimit:(long long)arg5 anchor:(long long)arg6;
- (_Bool)pptTest:(id)arg1 sampleQueryForType:(id)arg2 startDate:(id)arg3 endDate:(id)arg4 withLimit:(long long)arg5;
- (_Bool)pptTest:(id)arg1 saveDataWithCount:(long long)arg2;
...
+ (id)_workoutWithActivityType:(unsigned long long)arg1 startDate:(id)arg2 endDate:(id)arg3 workoutEvents:(id)arg4 duration:(double)arg5 totalEnergyBurned:(id)arg6 totalDistance:(id)arg7 goalType:(unsigned long long)arg8 goal:(id)arg9 metadata:(id)arg10 config:(CDUnknownBlockType)arg11;
