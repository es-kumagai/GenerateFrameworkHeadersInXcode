...
// UUID: 50E08910-89FF-3644-A07A-668B7FEFEE3F
//
//                           Arch: x86_64
...
@interface IBDocumentArchivingSchemaClassComponent_AddressBookDocumentArchiving_ABPersonView : IBDocumentArchivingSchemaClassComponent
{
}
...
@interface IBDocumentArchivingSchemaClassComponent_AddressBookDocumentArchiving_ABPeoplePickerView : IBDocumentArchivingSchemaClassComponent
{
}
...
@interface IBDocumentArchivingSchemaClassComponent_DiscRecordingPluginDocumentArchiving_DRMSFFormatter : IBDocumentArchivingSchemaClassComponent
{
}
...
@interface IBDocumentArchivingSchemaClassComponent_IBMapKitDocumentArchiving_MKMapViewTemplate : IBDocumentArchivingSchemaClassComponent
{
}
...
@interface IBNSStoryboardRelationshipSegue : IBStoryboardRelationshipSegue
{
}
...
{
    NSTextField *unformattedField;
    NSTextField *formattedField;
    IDEInspectorKeyPath *_sampleUnformattedValueKeyPath;
    IDEInspectorKeyPath *_sampleFormattedValueKeyPath;
}
...
@interface IBDocumentArchivingSchemaEnumerationComponent_NSPopoverAppearance : IBDocumentArchivingSchemaEnumerationComponent
{
}
...
- (void)ibWarnings:(id)arg1 forDocument:(id)arg2 withComputationContext:(id)arg3;
- (id)ibSwizzledInitWithFrame:(struct CGRect)arg1;
- (id)ibSwizzledInitWithCoder:(id)arg1;
- (void)_ibSwizzledCommonInit;
- (void)drawRect:(struct CGRect)arg1;
@property(retain) NSArray *propertyList;
@end
...
@interface ABPersonView (IBDocumentArchivingGenerator) <IBDocumentArchiving>
- (void)unarchiveWithDocumentUnarchiver:(id)arg1;
- (void)archiveWithDocumentArchiver:(id)arg1;
...
@interface ABPeoplePickerView (IBDocumentArchivingGenerator) <IBDocumentArchiving>
- (void)unarchiveWithDocumentUnarchiver:(id)arg1;
- (void)archiveWithDocumentArchiver:(id)arg1;
...
@interface IBDocument (IBCocoaDocumentInspectorAdditions)
