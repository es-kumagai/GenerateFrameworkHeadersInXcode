...
// UUID: D3187394-0C03-3FCF-8536-2F7BAD35F83C
//
//                           Arch: x86_64
...
- (void)setCurrentToneIdentifier:(NSString *)arg1 keyedByAccountIdentifier:(NSString *)arg2 forPreferenceKey:(NSString *)arg3 completionHandler:(void (^)(_Bool, NSError *))arg4;
...
- (void)_stopRepeatedlyPlayingAlert:(id)arg1 withFadeOutDuration:(double)arg2 options:(unsigned long long)arg3 completionHandler:(CDUnknownBlockType)arg4 targetQueue:(id)arg5;
