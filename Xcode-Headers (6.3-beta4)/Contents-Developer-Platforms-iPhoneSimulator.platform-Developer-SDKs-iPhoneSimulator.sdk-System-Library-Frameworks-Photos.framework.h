...
// UUID: FC55AE8C-9FCD-3E3A-9CEC-719FFC32556E
//
//                           Arch: x86_64
...
@interface PHCachingImageManager : PHImageManager
{
    ...
    _Bool _shouldPurgePreheatItems;
...
@interface PHQuery : NSObject <NSCopying>
{
    ...
    _Bool __includesCloudSharedAssets;
    _Bool __includesiTunesSyncAssets;
...
@property(nonatomic, setter=_setIncludesiTunesSyncAssets:) _Bool _includesiTunesSyncAssets; // @synthesize _includesiTunesSyncAssets=__includesiTunesSyncAssets;
@property(nonatomic, setter=_setIncludesCloudSharedAssets:) _Bool _includesCloudSharedAssets; // @synthesize _includesCloudSharedAssets=__includesCloudSharedAssets;
