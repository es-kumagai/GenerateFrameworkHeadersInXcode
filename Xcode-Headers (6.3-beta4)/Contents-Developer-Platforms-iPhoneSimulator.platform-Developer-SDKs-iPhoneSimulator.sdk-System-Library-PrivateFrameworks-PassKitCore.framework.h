...
// UUID: E7A93B2C-1EE6-3467-9ACD-421184DA6BA5
//
//                           Arch: x86_64
...
- (void)setPreventPaymentInterfacePresentation:(_Bool)arg1;
...
- (void)setNewAuthRandomIfNecessaryWithRetryCount:(unsigned long long)arg1 completion:(CDUnknownBlockType)arg2;
...
- (void)_performRequest:(id)arg1 retries:(unsigned long long)arg2 authHandling:(_Bool)arg3 completionHandler:(CDUnknownBlockType)arg4;
...
- (void)registerDeviceWithConsistencyData:(id)arg1 retries:(unsigned long long)arg2 completion:(CDUnknownBlockType)arg3;
...
@property(readonly, nonatomic) _Bool originatedFromThisDevice;
- (id)description;
