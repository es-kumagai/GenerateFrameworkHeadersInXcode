...
//
// File: /Applications/Xcode.app/Contents/PlugIns/IDEiPhoneSupport.ideplugin/Contents/MacOS/IDEiPhoneSupport
// UUID: 8E560D32-4BF8-31DD-96E6-052BF3522CF3
//
//                           Arch: x86_64
...
@interface ITunesSoftwareServiceProxy : NSObject
{
}

+ (id)service;
+ (id)pathPrefixedWithDeveloperDir:(id)arg1;
...
@interface IDEiOSBuildPropertyDefinitionArchitecturesNodeAdapterValidator : NSObject
{
}

- (BOOL)shouldRejectExpandedArchitectureValue:(id)arg1 expandedDeploymentTarget:(id)arg2 changeDeploymentTargetAndArchsBlock:(CDUnknownBlockType)arg3 error:(id *)arg4;
...
// Remaining properties
@property(readonly, nonatomic) Xcode3BackgroundModesItemModel *model;
...
// Remaining properties
@property(readonly, nonatomic) Xcode3InterAppAudioItemModel *model;
