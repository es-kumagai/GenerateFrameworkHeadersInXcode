...
// UUID: 1B9A7145-5202-3EBF-9002-A1C572A13D80
//
//                           Arch: x86_64
//                Current version: 1.0.0
//          Compatibility version: 1.0.0
//                 Source version: 1501.7.43.0.0
...
@property(readonly, retain, nonatomic) UIImageView *chevron;
@property(retain, nonatomic) CKMediaObject *mediaObject;
@end
...
@property(readonly, nonatomic) double statusButtonCharge;
...
// Remaining properties
@property(readonly, retain, nonatomic) CKTypingIndicatorLayer *layer; // @dynamic layer;
...
@interface NSDate (CKNanoEventManager)
+ (id)eod;
+ (id)bod;
@end
