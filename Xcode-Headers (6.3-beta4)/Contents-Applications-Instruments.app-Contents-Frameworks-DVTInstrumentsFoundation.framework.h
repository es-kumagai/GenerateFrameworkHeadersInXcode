...
// UUID: ADA26E35-673C-36ED-BA82-DBEB4FDBA73E
//
//                           Arch: x86_64
//                Current version: 56700.0.0
//          Compatibility version: 1.0.0
//                 Source version: 56715.0.0.0.0
...
@interface DTLeaksService : DTXService <DTLeaksServiceAuthorizedRPC>
{
    ...
    NSMutableDictionary *_helperByPid;
}

+ (void)registerCapabilities:(id)arg1;
- (void).cxx_destruct;
- (void)cancelAllRequests;
- (void)interruptRequestsForPid:(int)arg1;
- (void)requestLeaksForPid:(id)arg1 context:(id)arg2 provideBacktraces:(id)arg3;
- (void)_internalRequestForPid:(int)arg1 message:(id)arg2 completion:(id)arg3;
- (void)messageReceived:(id)arg1;
- (id)initWithChannel:(id)arg1;
