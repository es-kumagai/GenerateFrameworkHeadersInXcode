...
// UUID: 181778EC-516C-345A-8F88-A73F06784A28
//
//                           Arch: x86_64
...
@interface HKDataUnitGroupChartingRules : NSObject
{
    ...
    _Bool _shouldOverrideMinYValue;
    _Bool _shouldHideAverageLine;
    _Bool _shouldStartDayAtNoon;
    _Bool _shouldUseFullYAxisRange;
    long long _defaultChartStyle;
    NSArray *_defaultYAxisChartBoundsRules;
    NSDictionary *_defaultYAxisChartBoundsRulesByUnit;
}

@property(nonatomic) _Bool shouldUseFullYAxisRange; // @synthesize shouldUseFullYAxisRange=_shouldUseFullYAxisRange;
...
@property(nonatomic) _Bool shouldOverrideMinYValue; // @synthesize shouldOverrideMinYValue=_shouldOverrideMinYValue;
...
- (void).cxx_destruct;
- (_Bool)adjustedValuesForMinValue:(double)arg1 maxValue:(double)arg2 minValueOut:(double *)arg3 maxValueOut:(double *)arg4;
...
- (void)_updateHKUnitPreferences:(id)arg1 shouldPostNotification:(_Bool)arg2;
