...
// UUID: 9011E786-B03B-3EFC-8761-42354C11C330
//
//                           Arch: x86_64
...
- (void)_waitForReplyWithKey:(id)arg1 afterBlock:(CDUnknownBlockType)arg2;
...
- (void).cxx_destruct;
- (void)stopWaiting;
- (void)waitAfterBlock:(CDUnknownBlockType)arg1;
- (void)dealloc;
