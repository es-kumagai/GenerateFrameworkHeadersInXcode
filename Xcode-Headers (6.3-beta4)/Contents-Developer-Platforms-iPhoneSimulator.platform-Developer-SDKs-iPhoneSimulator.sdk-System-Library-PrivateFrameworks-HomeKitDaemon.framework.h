...
// UUID: 0656CABA-46E7-3E74-8994-EF3BDDFBFB25
//
//                           Arch: x86_64
//                Current version: 86.8.0
...
- (void)fixupReplacementAccessories:(id)arg1 commonAccessories:(id)arg2 idsDataSync:(_Bool)arg3;
@property(readonly, copy) NSString *description;
...
- (void)notifySyncDataChanged;
- (void)setHomesConfigured:(_Bool)arg1;
- (id)replaceName:(id)arg1 withNewName:(id)arg2 inNamespaces:(id)arg3;
- (id)removeName:(id)arg1 namespace:(id)arg2;
- (id)addName:(id)arg1 namespace:(id)arg2;
