...
// UUID: D9ADBACB-9D56-37E1-8A57-0CA7BDA23072
//
//                           Arch: x86_64
//                Current version: 982.44.0
...
- (void)requestMUIDs:(NSArray *)arg1 resultProviderID:(int)arg2 includeETA:(_Bool)arg3 traits:(GEOMapServiceTraits *)arg4 requesterHandler:(void (^)(NSArray *, NSError *))arg5;
@end
...
- (void)requestMUIDs:(id)arg1 resultProviderID:(int)arg2 includeETA:(_Bool)arg3 traits:(id)arg4 networkActivity:(CDUnknownBlockType)arg5 requesterHandler:(CDUnknownBlockType)arg6;
...
- (void)requestMUIDs:(id)arg1 resultProviderID:(int)arg2 includeETA:(_Bool)arg3 traits:(id)arg4 requesterHandler:(CDUnknownBlockType)arg5;
- (void)dealloc;
- (id)init;
...
- (void)requestPhoneNumbers:(id)arg1 allowCellularDataForLookup:(_Bool)arg2 traits:(id)arg3 requesterHandler:(CDUnknownBlockType)arg4;
- (void)_requestMUIDsFromNetwork:(id)arg1 resultProviderID:(int)arg2 includeETA:(_Bool)arg3 traits:(id)arg4 finished:(CDUnknownBlockType)arg5 error:(CDUnknownBlockType)arg6;
- (void)requestMUIDs:(id)arg1 resultProviderID:(int)arg2 includeETA:(_Bool)arg3 traits:(id)arg4 requesterHandler:(CDUnknownBlockType)arg5;
- (void)cancelRequest:(id)arg1;
...
- (id)ticketForMUIDs:(id)arg1 resultProviderID:(int)arg2 includeETA:(_Bool)arg3 traits:(id)arg4;
...
- (_Bool)_changeActiveTileGroup:(id)arg1 flushTileCache:(_Bool)arg2 error:(id *)arg3;
- (void)_loadFromDisk;
- (void)_startServer;
- (id)configuration;
- (id)authToken;
...
- (void)cancel;
- (void)_writeResourceToDisk:(id)arg1 withData:(id)arg2 orExistingPathOnDisk:(id)arg3 allowCreatingHardLink:(_Bool)arg4 checksum:(id)arg5 completionHandler:(CDUnknownBlockType)arg6;
