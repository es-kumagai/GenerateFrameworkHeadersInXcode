...
// UUID: 45F07C1C-212F-33E0-8882-8DB1922C0B68
//
//                           Arch: x86_64
...
@interface DVTDeviceSummaryViewController : DVTViewController <DVTDevicesWindowDetailViewController, NSTableViewDataSource, DVTTableViewDelegate>
{
    ...
    DVTObservingToken *_proxyInfoObservationToken;
    ...
    DVTObservingToken *_showProxiedDevicesObservingToken;
    BOOL _showProxiedDeviceSlice;
    DVTDevice *_device;
...
@property BOOL showProxiedDeviceSlice; // @synthesize showProxiedDeviceSlice=_showProxiedDeviceSlice;
