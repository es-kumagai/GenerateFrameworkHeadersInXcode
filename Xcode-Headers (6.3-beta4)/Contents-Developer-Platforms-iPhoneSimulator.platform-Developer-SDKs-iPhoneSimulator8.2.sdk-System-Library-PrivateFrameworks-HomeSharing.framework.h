...
// UUID: 4906DA3C-AF6C-338D-AEA1-ED413C006DD0
//
//                           Arch: x86_64
...
- (void)addStorePlaylistsWithGlobalIDs:(NSArray *)arg1 completion:(void (^)(NSError *))arg2;
- (void)addStoreItemsWithAdamIDs:(NSArray *)arg1 completion:(void (^)(NSError *))arg2;
- (void)removePlaylistWithSagaID:(unsigned long long)arg1 completion:(void (^)(NSError *))arg2;
- (void)savePlaylistWithPersistentID:(unsigned long long)arg1 itemSagaIDs:(NSArray *)arg2 completion:(void (^)(unsigned int, NSError *))arg3;
- (void)addPlaylistWithPersistentID:(unsigned long long)arg1 name:(NSString *)arg2 completion:(void (^)(unsigned long long, NSError *))arg3;
...
+ (struct PropertyInfo *)sharedPropertyInfo;
+ (_Bool)isSupportedItemProperty:(id)arg1;
