...
// UUID: F308C26A-F2EB-3A0B-AEF3-B9F6559B4207
//
//                           Arch: x86_64
...
+ (_Bool)supportsSecureCoding;
- (void)_setApplyChanges:(_Bool)arg1;
@property(nonatomic) _Bool applyChanges; // @synthesize applyChanges=_applyChanges;
...
+ (_Bool)supportsSecureCoding;
@property(retain, nonatomic) AFAlarm *alarm; // @synthesize alarm=_alarm;
- (void).cxx_destruct;
- (id)initWithCoder:(id)arg1;
- (void)encodeWithCoder:(id)arg1;
- (id)createResponse;
...
@interface SAPersonAttribute (AFContactAddress)
