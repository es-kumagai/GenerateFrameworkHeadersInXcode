...
// UUID: EE3C13D7-948A-3FC4-AB29-6BC1C1C7E82F
//
//                           Arch: x86_64
//                Current version: 2341.1.0
...
- (id)initWithIccid:(id)arg1 subscriptionResult:(int)arg2 autoRenew:(_Bool)arg3 billingStartDate:(double)arg4 billingEndDate:(double)arg5 carrierName:(id)arg6 planType:(int)arg7 planDescription:(id)arg8 planStatus:(int)arg9 accountStatus:(int)arg10 accountURL:(id)arg11 timestamp:(double)arg12 dataUsage:(id)arg13;
...
- (void)_subscriptionDetailsWithCompletion:(CDUnknownBlockType)arg1 updateIfNeeded:(_Bool)arg2;
...
- (void)_plansForRenewal:(_Bool)arg1 progress:(CDUnknownBlockType)arg2 completion:(CDUnknownBlockType)arg3 latitude:(id)arg4 longitude:(id)arg5;
