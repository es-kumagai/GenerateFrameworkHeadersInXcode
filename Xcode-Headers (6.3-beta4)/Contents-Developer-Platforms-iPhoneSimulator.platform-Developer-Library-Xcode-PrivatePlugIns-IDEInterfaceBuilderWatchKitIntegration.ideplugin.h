...
//
// File: /Applications/Xcode.app/Contents/Developer/Platforms/iPhoneSimulator.platform/Developer/Library/Xcode/PrivatePlugIns/IDEInterfaceBuilderWatchKitIntegration.ideplugin/Contents/MacOS/IDEInterfaceBuilderWatchKitIntegration
// UUID: 87A63DC3-8ECD-3D21-9DA7-00B8C4FFD572
//
//                           Arch: x86_64
//                Current version: 3733.0.0
//          Compatibility version: 1.0.0
//                 Source version: 6764.0.0.0.0
...
{
    IBSPGlanceEntryPointIndicator *_entryPointIndicator;
...
@property(readonly, nonatomic) IBSPGlanceEntryPointIndicator *entryPointIndicator; // @synthesize entryPointIndicator=_entryPointIndicator;
- (void).cxx_destruct;
...
- (id)ibInspectedTemplateImagesForKeyPath:(id)arg1 maxEnumValue:(long long)arg2 sourceRect:(struct CGRect)arg3;
@property long long ibInspectedBottomTemplateType;
@property long long ibInspectedTopTemplateType;
...
@interface IBSPGlanceEntryPointIndicator : IBSPInterfaceObject <IBStoryboardEntryPointIndicator>
{
}
...
- (void).cxx_destruct;
- (CDStruct_04000243)activeKnobRectsForObject:(id)arg1;
...
@interface IBPepperDocumentCompiler : IBDocumentCompiler
{
}
...
- (void)unarchiveWithDocumentUnarchiver:(id)arg1;
- (void)archiveWithDocumentArchiver:(id)arg1;
- (BOOL)ibInspectedIsNotGlanceTemplateLabel;
...
- (id)ibSubitemsPasteboardTypeForEditor;
- (id)ibDragAndDropSubitemsKeyPath;
- (CDStruct_04000243)ibFilteredKnobRects:(CDStruct_04000243)arg1;
- (id)ibTrackableHeightKeyPath;
- (id)ibTrackableWidthKeyPath;
...
- (long long)fileTypeForVariantIdentifier:(id)arg1;
...
- (id)ibPlistGlobalTintColor;
- (id)ibCompiledPlistAsEntryPointInStoryboard:(id)arg1 fileType:(long long)arg2;
- (id)ibReachableControllersInStoryboard:(id)arg1 forCompiledFileType:(long long)arg2;
- (long long)ibMarshalledFileType;
- (id)ibPlistRootValueAsEntryPointInStoryboard:(id)arg1 fileType:(long long)arg2;
- (id)ibPlistIdentifierInDocument:(id)arg1;
- (id)ibPasteboardTypes;
...
@interface IBSPInterfaceObjectTracker : NSObject
{
    ...
    long long _knobInRemoteView;
}

@property(readonly, nonatomic) long long knobInRemoteView; // @synthesize knobInRemoteView=_knobInRemoteView;
...
- (double)maxWidth;
- (long long)knobInSpaceOfView:(id)arg1;
- (id)overlayView;
- (id)editorCanvasFrame;
- (id)document;
- (id)initWithTrackedObject:(id)arg1 remoteView:(id)arg2 frameController:(id)arg3 knobInRemoteView:(long long)arg4;
...
@property(readonly) IBSPGlanceInterfaceController *glanceInterfaceEntryPoint;
