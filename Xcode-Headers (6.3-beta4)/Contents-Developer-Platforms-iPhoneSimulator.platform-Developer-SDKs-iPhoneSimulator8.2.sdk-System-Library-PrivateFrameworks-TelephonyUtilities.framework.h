...
// UUID: 2F5F7184-5797-3F31-A82F-713F68578C99
//
//                           Arch: x86_64
//                Current version: 1.0.0
//          Compatibility version: 1.0.0
//                 Source version: 402.25.19.0.0
...
- (void)setShouldSuppressRingtone:(_Bool)arg1 forCallWithCallUUID:(NSString *)arg2;
...
- (void)handleShouldSuppressRingtoneChangedTo:(_Bool)arg1 forCallWithUUID:(NSString *)arg2;
...
- (void)setIsSendingAudio:(_Bool)arg1 forCall:(TUProxyCall *)arg2;
...
+ (void)_setCTCapability:(struct __CFString *)arg1 value:(_Bool)arg2;
...
+ (void)_setRelayCallingFeaturesEnabledDefault:(_Bool)arg1;
+ (_Bool)_relayCallingFeaturesEnabledDefault;
...
- (void)_updateCallWithCallState:(id)arg1 loadPersistentState:(_Bool)arg2;
...
- (void)handleShouldSuppressRingtoneChangedTo:(_Bool)arg1 forCallWithUUID:(id)arg2;
...
- (void)setIsSendingAudio:(_Bool)arg1 forCall:(id)arg2;
- (id)dial:(id)arg1 callID:(int)arg2 service:(int)arg3 sourceIdentifier:(id)arg4;
- (void)requestHandoffForAllCalls;
- (void)setShouldSuppressRingtone:(_Bool)arg1 forCall:(id)arg2;
...
{
    _Bool _inCallServiceActive;
    id <TUStatusBarManagerDelegate> _delegate;
    NSString *_currentStatusBarString;
    NSTimer *_callDurationUpdateTimer;
}

@property(nonatomic, getter=isInCallServiceActive) _Bool inCallServiceActive; // @synthesize inCallServiceActive=_inCallServiceActive;
...
- (void)_endConference:(_Bool)arg1;
...
- (void)startConferenceForIdentifier:(id)arg1 withSocket:(int)arg2 asHost:(_Bool)arg3 didStartHandler:(CDUnknownBlockType)arg4 didStopHandler:(CDUnknownBlockType)arg5;
- (void)setSendingAudio:(_Bool)arg1 forIdentifier:(id)arg2;
- (_Bool)isSendingAudioForIdentifier:(id)arg1;
- (void)setMuted:(_Bool)arg1 forIdentifier:(id)arg2;
- (_Bool)isMutedForIdentifier:(id)arg1;
- (void)dealloc;
- (id)init;
...
+ (id)conferenceConnectionWithIdentifier:(id)arg1 host:(_Bool)arg2;
...
- (void)joinConference;
- (_Bool)isConferenced;
- (void)_setPrimitiveShouldSuppressRingtone:(_Bool)arg1;
...
+ (void)allowCallForDestinationID:(id)arg1 service:(int)arg2 completionHandler:(CDUnknownBlockType)arg3;
+ (_Bool)allowCallForDestinationID:(id)arg1 service:(int)arg2;
...
- (void)requestHandoffForAllCalls;
- (_Bool)requestHandoffWithInfo:(id)arg1;
- (void)disconnectAllCalls;
- (void)disconnectCurrentCallAndActivateHeld;
