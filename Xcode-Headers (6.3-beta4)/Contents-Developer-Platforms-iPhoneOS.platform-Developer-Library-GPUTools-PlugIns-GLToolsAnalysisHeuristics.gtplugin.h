...
//
// File: /Applications/Xcode.app/Contents/Developer/Platforms/iPhoneOS.platform/Developer/Library/GPUTools/PlugIns/GLToolsAnalysisHeuristics.gtplugin/Contents/MacOS/GLToolsAnalysisHeuristics
// UUID: 15B4C70D-57E4-3463-B8F1-F228BFE8BBF0
//
//                           Arch: x86_64
...
@interface DYGLAnalyzerHeuristic_InvalidBufferUsage : DYGLAnalyzerHeuristic
{
    ...
    const FramebufferAttachment_0f262785 *_pDepthAttachment;
}
...
+ (const FramebufferAttachment_0f262785 *)_getAttachment:(ContextStateMirror_daaf80d0 *)arg1 buffer:(int)arg2 drawBuffer:(int)arg3;
+ (id)identifier;
...
- (void)_checkColorBuffer:(const struct Function *)arg1 context:(ContextStateMirror_daaf80d0 *)arg2 drawBuffer:(int)arg3 hasFormatType:(int)arg4;
- (void)_checkAttachment:(const struct Function *)arg1 context:(ContextStateMirror_daaf80d0 *)arg2 framebufferID:(int)arg3 attachmentPoint:(int)arg4 attachment:(const FramebufferAttachment_0f262785 *)arg5;
...
@interface DYGLAnalyzerHeuristic_DataInitialization : DYGLAnalyzerHeuristic
{
    int currCaptureBlockMode;
    int currTextureType;
    ...
    DYGLAnalyzerSharegroupObjectCoverage *coverage;
...
- (void)endBlock:(int)arg1;
- (void)startBlock:(int)arg1;
- (void)_transformFeedbackProvideCoverage:(const struct Function *)arg1 context:(const ContextStateMirror_daaf80d0 *)arg2 numVertices:(int)arg3;
- (DYSpanList_2e1c4d62)_subImageSpansForPackUnpack:(const ContextStateMirror_daaf80d0 *)arg1 format:(int)arg2 type:(int)arg3 x:(int)arg4 y:(int)arg5 z:(int)arg6 width:(int)arg7 height:(int)arg8 depth:(int)arg9 offset:(long long)arg10 useUnpackState:(BOOL)arg11;
- (const TextureLayer_6b03800d *)_texLayerOfAttachment:(const FramebufferAttachment_0f262785 *)arg1 context:(ContextStateMirror_daaf80d0 *)arg2;
- (void)_determineBlitFBDestRect:(ContextStateMirror_daaf80d0 *)arg1 x0:(int)arg2 y0:(int)arg3 x1:(int)arg4 y1:(int)arg5 attachments:(vector_590fc35f *)arg6 outRect:(struct DYRegionRect *)arg7;
- (void)_determineBlitFBRect:(ContextStateMirror_daaf80d0 *)arg1 x0:(int)arg2 y0:(int)arg3 x1:(int)arg4 y1:(int)arg5 attachments:(vector_590fc35f *)arg6 outRect:(struct DYRegionRect *)arg7;
- (void)_getBlitFBDestAttachmentsForContext:(const ContextStateMirror_daaf80d0 *)arg1 outAttachments:(vector_590fc35f *)arg2 mask:(unsigned int)arg3;
- (void)_getBlitFBSourceAttachmentsForContext:(const ContextStateMirror_daaf80d0 *)arg1 outAttachments:(vector_590fc35f *)arg2 mask:(unsigned int)arg3;
...
- (void)_updateFBOAttachment:(const FramebufferAttachment_0f262785 *)arg1 attachmentType:(int)arg2 region:(const struct DYRegionRect *)arg3 writeMask:(unsigned int)arg4 function:(const struct Function *)arg5;
...
- (BOOL)_isAttachmentCovered:(const FramebufferAttachment_0f262785 *)arg1 inRect:(const struct DYRegionRect *)arg2 channelBits:(unsigned int)arg3;
- (BOOL)_isAttachmentCovered:(const FramebufferAttachment_0f262785 *)arg1 channelBits:(unsigned int)arg2;
- (BOOL)isReadFBOAttachmentCovered:(int)arg1 channelBits:(unsigned int)arg2;
- (void)checkTexturesInUse:(const struct Function *)arg1;
- (void)checkUniformBuffersInUse:(const struct Function *)arg1 context:(ContextStateMirror_daaf80d0 *)arg2;
...
- (void)_checkBufferInUse:(int)arg1 context:(ContextStateMirror_daaf80d0 *)arg2 function:(const struct Function *)arg3;
...
@interface DYGLAnalyzerEngineFactory : DYAnalyzerEngineFactory
{
}
