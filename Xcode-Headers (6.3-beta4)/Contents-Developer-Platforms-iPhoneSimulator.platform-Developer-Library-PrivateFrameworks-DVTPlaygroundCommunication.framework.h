...
//
// File: /Applications/Xcode.app/Contents/Developer/Platforms/iPhoneSimulator.platform/Developer/Library/PrivateFrameworks/DVTPlaygroundCommunication.framework/DVTPlaygroundCommunication
// UUID: 05D3CE0E-A6B1-3474-9E32-A798B0C4A140
//
//                           Arch: x86_64
...
- (void)close;
- (void)sendData:(id)arg1 metaData:(id)arg2 dataIdentifier:(id)arg3 version:(unsigned long long)arg4 isSerializable:(_Bool)arg5 completionBlock:(CDUnknownBlockType)arg6;
- (id)init;
