...
//
// File: /Applications/Xcode.app/Contents/Developer/Platforms/iPhoneOS.platform/Developer/Library/Xcode/PrivatePlugIns/GPUDebuggeriOSSupport.ideplugin/Contents/MacOS/GPUDebuggeriOSSupport
// UUID: 48230C93-6DDC-3FFC-AA66-5AA26EEAB557
//
//                           Arch: x86_64
...
@interface GPUTraceProgramGroup (GPUTraceOutlineItemNavigableItemPropertySupport)
...
@interface GPUTraceShaderItem (GPUTraceOutlineItemNavigableItemPropertySupport)
- (id)navigableItem_subtitle;
@end

@interface GPUTraceDisplayableItem (GPUTraceOutlineItemNavigableItemPropertySupport)
- (id)navigableItem_subtitle;
@end
