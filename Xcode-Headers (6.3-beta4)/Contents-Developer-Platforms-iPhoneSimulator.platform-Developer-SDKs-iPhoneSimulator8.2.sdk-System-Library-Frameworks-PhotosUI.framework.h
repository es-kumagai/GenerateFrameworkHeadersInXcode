...
// UUID: 1FB8688E-166B-3518-868D-59EDD7F7375F
//
//                           Arch: x86_64
...
@optional
- (_Bool)photoBrowserControllerShouldHandleLibraryChangesInternally:(PLPhotoBrowserController *)arg1;
...
@property(nonatomic, getter=goButtonIsVisible) _Bool goButtonVisible; // @synthesize goButtonVisible=_goButtonVisible;
...
- (void)_waitForCondition:(CDUnknownBlockType)arg1 withRetryCount:(long long)arg2 retryInterval:(double)arg3 handler:(CDUnknownBlockType)arg4;
- (void)_waitUntilReadyToTransitionToShareSheetWithHandler:(CDUnknownBlockType)arg1;
...
- (id)_getDisplayableAssetsForStandInCollectionList:(id)arg1 maximumCount:(long long)arg2 useCache:(_Bool)arg3;
...
- (_Bool)_isCachedFetchResultOutdatedForCollection:(id)arg1;
