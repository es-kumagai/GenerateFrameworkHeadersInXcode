...
// UUID: 5F4D2DC9-A405-3F5B-AA70-2EBC18A7DB2C
//
//                           Arch: x86_64
...
- (oneway void)getLanguageResourcesWithCompletion:(void (^)(ML3LanguageResources *, NSError *))arg1;
...
- (oneway void)performImportFromSource:(unsigned long long)arg1 intoDatabaseAtPath:(NSString *)arg2 withTrackData:(NSData *)arg3 withPlaylistData:(NSData *)arg4 withFileHandle:(NSFileHandle *)arg5 options:(NSDictionary *)arg6 identifier:(NSUUID *)arg7 completionHandler:(void (^)(_Bool, NSError *, NSData *))arg8;
...
+ (id)predicateIncludingSystemwidePredicatesWithPredicate:(id)arg1 library:(id)arg2 ignoreRestrictions:(_Bool)arg3;
...
+ (id)_purgeableTrackPredicateWithUrgency:(unsigned long long)arg1 includeCloudAssets:(_Bool)arg2;
...
- (void)_enumeratePurgeableTracksForUrgency:(unsigned long long)arg1 includeCloudAssets:(_Bool)arg2 usingBlock:(CDUnknownBlockType)arg3;
...
- (long long)fetchItemScreenshotSourceTypeForPersistentID:(long long)arg1;
- (long long)fetchItemArtworkSourceTypeForPersistentID:(long long)arg1;
...
@property(nonatomic) _Bool companionDeviceActiveStoreAccountIsDynamiteEligible;
...
- (_Bool)_updateEntityRevisionForItemWithPersistentID:(id)arg1 withDeletionType:(int)arg2 revisionTrackingCode:(long long)arg3 revisionType:(int)arg4 usingConnection:(id)arg5;
- (_Bool)_deleteMismatchedCollectionWithPersistentID:(id)arg1 ofCollectionClass:(Class)arg2 usingConnection:(id)arg3;
- (_Bool)_coalesceMismatchedCollectionClass:(Class)arg1 usingConnection:(id)arg2;
- (_Bool)_coalesceMismatchedCollectionsUsingConnection:(id)arg1;
...
@property(copy, nonatomic) NSArray *propertiesToPrefetch; // @synthesize propertiesToPrefetch=_propertiesToPrefetch;
...
@property(readonly, nonatomic) NSString *nameOrderPropertyForSectionProperty;
...
- (void)enumeratePersistentIDsAndProperties:(id)arg1 ordered:(_Bool)arg2 sectionProperty:(id)arg3 subCollectionProperty:(id)arg4 cancelBlock:(CDUnknownBlockType)arg5 usingBlock:(CDUnknownBlockType)arg6;
...
- (void)resultAtIndex:(unsigned long long)arg1 withCompletion:(CDUnknownBlockType)arg2;
- (id)resultAtIndex:(unsigned long long)arg1;
...
- (void)_mergeChangesWithFromNewPIDs:(const vector_d87a6415 *)arg1 changedPIDs:(unordered_set_f2692727 *)arg2;
- (void)_loadCurrentFullResultsAtIndex:(unsigned long long)arg1;
- (CDStruct_383aa905)_sectionForRowIndex:(unsigned long long)arg1 withSections:(const vector_a1de3f0d *)arg2;
...
- (oneway void)performImportFromSource:(unsigned long long)arg1 intoDatabaseAtPath:(id)arg2 withTrackData:(id)arg3 withPlaylistData:(id)arg4 withFileHandle:(id)arg5 options:(id)arg6 progressBlock:(CDUnknownBlockType)arg7 completionHandler:(CDUnknownBlockType)arg8;
- (void)performImportFromSource:(unsigned long long)arg1 intoDatabaseAtPath:(id)arg2 withTrackData:(id)arg3 withPlaylistData:(id)arg4 options:(id)arg5 completionHandler:(CDUnknownBlockType)arg6;
...
@property(nonatomic) _Bool isPlaylistOnly; // @synthesize isPlaylistOnly=_isPlaylistOnly;
...
@property(nonatomic) _Bool hasMatchedStoreItemId;
...
@property(nonatomic) _Bool hasIsPlaylistOnly;
