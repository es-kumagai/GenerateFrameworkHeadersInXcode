...
//
// File: /Applications/Xcode.app/Contents/Developer/Platforms/iPhoneSimulator.platform/Developer/Library/Xcode/PrivatePlugIns/IDEInterfaceBuilderCocoaTouchIntegration.ideplugin/Contents/MacOS/IDEInterfaceBuilderCocoaTouchIntegration
// UUID: 691D8841-B3DF-3AA6-B61A-2E4D36BD2DD5
//
//                           Arch: x86_64
//                Current version: 6736.0.0
...
@interface IBCocoaTouchBuildEnvironmentVerifier : IBBuildEnvironmentVerifier
{
}
...
@interface IBCocoaTouchSimulatorImageCatalogPlatformAdapter : IBAbstractCocoaTouchImageCatalogPlatformAdapter
{
}
...
@interface IBUIKeyCommandTableView : NSTableView
{
}
...
@interface IBUINavigationBarTitleRectsInfo : IBUIViewCachedItemFramesArrayInfo
{
...
@interface IBUISimulatedTabBarMetrics : IBUISimulatedBarMetrics <NSCoding, IBDocumentArchiving>
{
    int _barStyle;
    BOOL _translucent;
    NSColor *_tintColor;
...
+ (id)simulatedBarMetricsForBarView:(id)arg1;
+ (id)simulatedTabBarMetricsWithStyle:(int)arg1 translucent:(BOOL)arg2 tintColor:(id)arg3 barTintColor:(id)arg4;
...
@interface IBUIStoryboardTabBarControllerEditorView : IBUIViewControllerEditorView
{
}
...
@interface NSValue (IBDefaultValueMarshalling)
- (id)defaultDesignTimeMarshallerReferencingGlobalContext:(id)arg1;
@end
...
+ (BOOL)canHaveSeparateTopLevelCompiledPackagesForCocoaTouchDevices;
...
- (BOOL)compilesSeparateContentForTargetDevicesOnIOSVersionsPriorToEight:(id)arg1;
