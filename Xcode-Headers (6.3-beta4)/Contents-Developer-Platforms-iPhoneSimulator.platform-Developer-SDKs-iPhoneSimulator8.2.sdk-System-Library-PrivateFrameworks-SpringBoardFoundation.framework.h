...
// UUID: 54CE4831-ABFA-3E3F-A4C9-B3E84E90E19D
//
//                           Arch: x86_64
...
- (void)dealloc;
- (id)initWithName:(id)arg1 parallaxFactor:(double)arg2 zoomScale:(double)arg3 supportsCropping:(_Bool)arg4 cropRect:(struct CGRect)arg5 portrait:(_Bool)arg6;
...
- (void)updateLockControllerDefaultsWithBlock:(CDUnknownBlockType)arg1 journaled:(_Bool)arg2;
- (id)lastLockDate;
- (void)dealloc;
- (id)init;
