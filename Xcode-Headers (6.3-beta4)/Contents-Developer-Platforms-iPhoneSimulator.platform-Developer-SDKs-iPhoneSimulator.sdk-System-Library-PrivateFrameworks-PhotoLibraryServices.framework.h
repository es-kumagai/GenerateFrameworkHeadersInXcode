...
// UUID: D53495C4-4FFA-3241-9038-8369B388C8F4
//
//                           Arch: x86_64
...
@property(readonly, nonatomic) unsigned long long videoDeletionsSinceLastSync; // @synthesize videoDeletionsSinceLastSync=_videoDeletionsSinceLastSync;
@property(readonly, nonatomic) unsigned long long imageDeletionsSinceLastSync; // @synthesize imageDeletionsSinceLastSync=_imageDeletionsSinceLastSync;
...
+ (id)createImageDataFromCGImage:(struct CGImage *)arg1 withCompressionQuality:(double)arg2 metadataSourceImageURL:(id)arg3 preserveRegionsInMetadata:(_Bool)arg4;
